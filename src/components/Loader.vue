<template>
  <div class="w-full flex justify-center  items-center mt-10 mb-5">
    <h1 class="mb-8 text-center text-lg font-medium">
      <p v-if="store.loading && store.checkingAnswer">Waiting for answer</p>
      <p v-if="store.loading && !store.checkingAnswer">Waiting for question</p>
    </h1>
  </div>
